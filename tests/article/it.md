...
**执行存证**: `test-evidence/article-and-featured-feed/TC-article-IT-001/`
**最后更新**: 2026-08-16
...
**状态**: ✅ 通过
**执行方式**: api-test-runner
**执行存证**: `test-evidence/article-and-featured-feed/TC-article-IT-002/`
**最后更新**: 2026-08-16
...
**状态**: ✅ 通过
**执行方式**: api-test-runner
**执行存证**: `test-evidence/article-and-featured-feed/TC-article-IT-003/`
**最后更新**: 2026-08-16
...
**状态**: ✅ 通过
**执行方式**: api-test-runner
**执行存证**: `test-evidence/article-and-featured-feed/TC-article-IT-004/`
**最后更新**: 2026-08-16
...
**状态**: ✅ 通过
**执行方式**: api-test-runner
**执行存证**: `test-evidence/article-and-featured-feed/TC-article-IT-005/`
**最后更新**: 2026-08-16
...
**状态**: ✅ 通过
**执行方式**: api-test-runner
**执行存证**: `test-evidence/article-and-featured-feed/TC-article-IT-006/`
**最后更新**: 2026-08-16
...
**状态**: ✅ 通过
**执行方式**: api-test-runner
**执行存证**: `test-evidence/article-and-featured-feed/TC-article-IT-007/`
**最后更新**: 2026-08-16
...
**状态**: ✅ 通过
**执行方式**: api-test-runner
**执行存证**: `test-evidence/article-and-featured-feed/TC-article-IT-008/`
**最后更新**: 2026-08-16
...
**状态**: ✅ 通过
**执行方式**: api-test-runner
**执行存证**: `test-evidence/article-and-featured-feed/TC-article-IT-009/`
**最后更新**: 2026-08-16
...
**状态**: ✅ 通过
**执行方式**: api-test-runner
**执行存证**: `test-evidence/article-and-featured-feed/TC-article-IT-010/`
**最后更新**: 2026-08-16
...
**预期结果**: 栏目列表返回 200，按 sortOrder 升序（B 在前），每项含名称与 icon 签名 URL；文章列表返回 200，按 sortOrder 升序（权重 1 在前），每项含图片（签名 URL）、标题、副标题
**状态**: ✅ 通过
**执行方式**: api-test-runner
**执行存证**: `test-evidence/article-and-featured-feed/TC-article-IT-011/`
**最后更新**: 2026-08-16
...
**状态**: ✅ 通过
**执行方式**: api-test-runner
**执行存证**: `test-evidence/article-and-featured-feed/TC-article-IT-012/`
**最后更新**: 2026-08-16
...
**状态**: ✅ 通过
**执行方式**: api-test-runner
**执行存证**: `test-evidence/article-and-featured-feed/TC-article-IT-013/`
**最后更新**: 2026-08-16
...
**状态**: ✅ 通过
**执行方式**: api-test-runner
**执行存证**: `test-evidence/article-and-featured-feed/TC-article-IT-014/`
**最后更新**: 2026-08-16
