 ...
 * @param secondaryBackgroundImage 第二背景图 URL（可空）
...
public record CityUpdateRequest(
        ...
        @Pattern(regexp = "^(images|bound)/[\\w-]+\\.(png|jpg|webp|gif)$",
                message = "secondaryBackgroundImage 仅接受 OSS objectKey（images/<id>.<ext> 或 bound/<id>.<ext>）")
        String secondaryBackgroundImage,
