...
- ✅ Step 2: 含该条目，period=["OVULATION"]、type=ROUTE、targetId 等于该路线 id — ['OVULATION']
- ✅ Step 2: 响应无 routeId 字段 — ['banner', 'description', 'id', 'note', 'period', 'subtitle', 'targetId', 'title', 'type']
- ✅ Step 3: 返回 200 — 200
- ✅ Step 3: 数组不含该条目 — 0
- ✅ Step 4: 返回 200 — 200
- ✅ Step 4: 该条目重新出现 — 1
