...
## Step 1: 前置：POST /api/admin/merchants 创建商户（无 recommendReason）
...
{
  "id": "01a00b3d-4542-78a0-954e-44ed65268985",
  "name": "商户乙154239",
  "logo": {
  ...
  "createdAt": "2026-08-16T15:42:39.938453106Z",
  "updatedAt": "2026-08-16T15:42:39.938453106Z"
}
```

## Step 2: PUT /api/admin/merchants/{id} 加 recommendReason

```bash
curl -s -i -X PUT "http://localhost:21423/api/admin/merchants/01a00b3d-4542-78a0-954e-44ed65268985" -H "Authorization: Bearer $TOKEN" -H "Content-Type: application/json" -d '{
  "name": "商户乙154239",
  "logo": "images/logo-test.png",
  "address": "测试路 1 号",
  "longitude": 114.30,
...

{
  ...
  "createdAt": "2026-08-16T15:42:39.938453Z",
  "updatedAt": "2026-08-16T15:42:40.002346104Z"
}
```
...
```bash
curl -s -i -X GET "http://localhost:21423/api/admin/merchants/01a00b3d-4542-78a0-954e-44ed65268985" -H "Authorization: Bearer $TOKEN"
```
...

{
  ...
  "createdAt": "2026-08-16T15:42:39.938453Z",
  "updatedAt": "2026-08-16T15:42:40.004407Z"
}
```
