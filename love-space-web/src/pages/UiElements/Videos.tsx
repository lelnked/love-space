...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Tripleyourlife - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Tripleyourlife - React.js Tailwind CSS Admin Dashboard Template"
      />
