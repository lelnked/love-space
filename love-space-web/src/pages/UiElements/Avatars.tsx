...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Tripleyourlife - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Tripleyourlife - React.js Tailwind CSS Admin Dashboard Template"
      />
